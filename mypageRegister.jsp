...
<link rel="stylesheet" type="text/css" href="./assets/css/hostHeaderFooter.css">
<link rel="stylesheet" type="text/css" href="./assets/css/main.css">
<link rel="stylesheet" type="text/css" href="./assets/css/bootstrapConfig.css">
...
<body>
	...
	<div id="wrap">
		<div id="header" class="clearfix">
			<div id="section">
				...
				<ul class="clearfix">
					<li><a href=""><img src="./assets/img/mypageIcon.png"> 마이페이지</a></li>
					<li><a href=""><img src="./assets/img/logout.png"> 로그아웃</a></li>
				</ul>
			</div>
		</div>
	</div>
	...
	<div id="container">
		...
		<div id="process">
			<ul>
				<li class="imgs">
					<a href=""><span><img src="./assets/img/mypage.png" class="active"></span>
				...
				<li class="imgs">
					<a href=""><span><img src="./assets/img/introduce.png"></span>
					<span>소개작성</span></a>
				</li>
				<li class="prog">
					<br>
				...
				<li class="imgs">
					<a href=""><span><img src="./assets/img/rules.png"></span>
					<span>이용규칙 관리</span></a>
				</li>
				<li class="prog">
				<br>
				...
				<li class="imgs">
					<a href=""><span><img src="./assets/img/room.png"></span>
					<span>객실 관리</span></a>
				</li>
			</ul>
		</div>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="form-layer newline">
                                <span class="form-body">
                                    <input class="form-control normal-size" type="text" name="address2" placeholder="나머지 주소를 입력하세요." value="" disabled="disabled" style="margin-left: 95px">
                                </span>
                            </div>
                            <div class="form-layer mb_24">
