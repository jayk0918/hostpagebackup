...
--호스트가 업체등록
insert into company
values(SEQ_COMPANY_NO.nextval,3,'02-6653-9875','010-4001-2325','국민','김민규','04680104232123','week',2,'민규컴퍼니','김민규','321312312','78567','서울대입구역에그옐로우','123층','www.zxz.com','qqq@gmail.com');

insert into company
values(SEQ_COMPANY_NO.nextval,4,'02-7734-5195','010-9982-1354','국민','지금이순간','04233354652154','week',2,'밍키컴퍼니','김밍키','12312312312','22222','어디인지말롸~','14층','www.xxx.com','wwww@gmail.com');

insert into company
values(SEQ_COMPANY_NO.nextval,5,'02-6645-7335','010-7785-3320','국민','이건뭐냐','01452154979865','week',2,'양키컴퍼니','김양키','123213123123','43234','제주도~','1433층','www.ccc.com','eeeee@gmail.com');

insert into company
values(SEQ_COMPANY_NO.nextval,6,'02-3275-4195','010-1004-1009','국민','나도잘몰라','2123545232028','week',2,'짱꺠컴퍼니','김짱깨','124213123123','12321','대구','5214층','www.fff.com','r@gmail.com');

insert into company
values(SEQ_COMPANY_NO.nextval,7,'02-1515-1949','010-6565-9989','국민','허허','6548951235545','week',2,'캄퍼니','김퍼니','12123124123','46545','중궈','14321층','www.ggg.com','rrsda@gmail.com');
...
insert into gugun
values(seq_gugun_no.nextval,2,'성남시');

insert into sido
values(seq_sido_no.nextval,3,'경기도');
insert into gugun
values(seq_gugun_no.nextval,3,'용인시');

insert into sido
values(seq_sido_no.nextval,4,'제주도');
insert into gugun
values(seq_gugun_no.nextval,4,'제주시');

insert into sido
values(seq_sido_no.nextval,5,'서울특별시');
insert into gugun
values(seq_gugun_no.nextval,5,'강남구');
...
values('A01','냉장고','냉장고.png');

insert into s_amenities
values('A02','에어컨','에어컨.png');

insert into s_amenities
values('A03','TV','TV.png');

insert into s_amenities
values('A04','WIFI','WIFI.png');

insert into s_amenities
values('A05','욕실용품','욕실용품.png');

insert into s_amenities
values('A06','세탁기','세탁기.png');

insert into s_amenities
values('A07','드라이기','드라이기.png');

insert into s_amenities
values('A08','욕조','욕조.png');

insert into s_amenities
values('A09','반려견동반','반려견동반.png');

insert into s_amenities
values('A10','객실내 흡연','객실내 흡연.png');

insert into s_amenities
values('A11','취사가능','취사가능.png');

--펜션편의시설
insert into p_amenities
values(SEQ_P_AMENITIES_NO.nextval,1,'A01');

insert into p_amenities
values(SEQ_P_AMENITIES_NO.nextval,1,'A02');

insert into p_amenities
values(SEQ_P_AMENITIES_NO.nextval,1,'A03');

insert into p_amenities
values(SEQ_P_AMENITIES_NO.nextval,1,'A04');

insert into p_amenities
values(SEQ_P_AMENITIES_NO.nextval,1,'A05');

insert into p_amenities
values(SEQ_P_AMENITIES_NO.nextval,1,'A06');

insert into p_amenities
values(SEQ_P_AMENITIES_NO.nextval,1,'A07');

insert into p_amenities
values(SEQ_P_AMENITIES_NO.nextval,1,'A08'); 

insert into p_amenities
values(SEQ_P_AMENITIES_NO.nextval,1,'A09');

insert into p_amenities
values(SEQ_P_AMENITIES_NO.nextval,1,'A10');

insert into p_amenities
values(SEQ_P_AMENITIES_NO.nextval,1,'A11');


insert into p_amenities
values(SEQ_P_AMENITIES_NO.nextval,2,'A01');

insert into p_amenities
values(SEQ_P_AMENITIES_NO.nextval,2,'A02');

insert into p_amenities
values(SEQ_P_AMENITIES_NO.nextval,2,'A03');

insert into p_amenities
values(SEQ_P_AMENITIES_NO.nextval,2,'A04');

insert into p_amenities
values(SEQ_P_AMENITIES_NO.nextval,2,'A05');

insert into p_amenities
values(SEQ_P_AMENITIES_NO.nextval,2,'A06');


insert into p_amenities
values(SEQ_P_AMENITIES_NO.nextval,3,'A03');

insert into p_amenities
values(SEQ_P_AMENITIES_NO.nextval,3,'A04');

insert into p_amenities
values(SEQ_P_AMENITIES_NO.nextval,3,'A05');

insert into p_amenities
values(SEQ_P_AMENITIES_NO.nextval,3,'A06');

insert into p_amenities
values(SEQ_P_AMENITIES_NO.nextval,3,'A07');

insert into p_amenities
values(SEQ_P_AMENITIES_NO.nextval,3,'A08'); 

insert into p_amenities
values(SEQ_P_AMENITIES_NO.nextval,3,'A09');

insert into p_amenities
values(SEQ_P_AMENITIES_NO.nextval,3,'A10');

insert into p_amenities
values(SEQ_P_AMENITIES_NO.nextval,3,'A11');


insert into p_amenities
values(SEQ_P_AMENITIES_NO.nextval,4,'A01');

insert into p_amenities
values(SEQ_P_AMENITIES_NO.nextval,4,'A02');

insert into p_amenities
values(SEQ_P_AMENITIES_NO.nextval,4,'A03');

insert into p_amenities
values(SEQ_P_AMENITIES_NO.nextval,4,'A04');

insert into p_amenities
values(SEQ_P_AMENITIES_NO.nextval,4,'A05');

insert into p_amenities
values(SEQ_P_AMENITIES_NO.nextval,4,'A06');

insert into p_amenities
values(SEQ_P_AMENITIES_NO.nextval,4,'A07');

insert into p_amenities
values(SEQ_P_AMENITIES_NO.nextval,4,'A08'); 

insert into p_amenities
values(SEQ_P_AMENITIES_NO.nextval,4,'A09');

insert into p_amenities
values(SEQ_P_AMENITIES_NO.nextval,4,'A10');

insert into p_amenities
values(SEQ_P_AMENITIES_NO.nextval,4,'A11');


insert into p_amenities
values(SEQ_P_AMENITIES_NO.nextval,5,'A01');

insert into p_amenities
values(SEQ_P_AMENITIES_NO.nextval,5,'A02');

insert into p_amenities
values(SEQ_P_AMENITIES_NO.nextval,5,'A03');

insert into p_amenities
values(SEQ_P_AMENITIES_NO.nextval,5,'A04');

insert into p_amenities
values(SEQ_P_AMENITIES_NO.nextval,5,'A05');

insert into p_amenities
values(SEQ_P_AMENITIES_NO.nextval,5,'A06');

insert into p_amenities
values(SEQ_P_AMENITIES_NO.nextval,5,'A07');

insert into p_amenities
values(SEQ_P_AMENITIES_NO.nextval,5,'A08'); 

insert into p_amenities
values(SEQ_P_AMENITIES_NO.nextval,5,'A09');

insert into p_amenities
values(SEQ_P_AMENITIES_NO.nextval,5,'A10');

insert into p_amenities
values(SEQ_P_AMENITIES_NO.nextval,5,'A11');


--공용시설 서비스
insert into s_public
values('P01','수영장','수영장.png');

insert into s_public
values('P02','족구장','족구장.png');

insert into s_public
values('P03','카페','카페.png');

insert into s_public
values('P04','노래방','노래방.png');

insert into s_public
values('P05','편의점','편의점.png');

insert into s_public
values('P06','주차장','주차장.png');

insert into s_public
values('P07','BBQ','BBQ.png');

insert into s_public
values('P08','주방,식당','주방,식당.png');

insert into s_public
values('P09','흡연구역','흡연구역.png');

--펜션 공용시설
insert into p_public
values(SEQ_P_PUBLIC_NO.nextval,1,'P01');

insert into p_public
values(SEQ_P_PUBLIC_NO.nextval,1,'P02');

insert into p_public
values(SEQ_P_PUBLIC_NO.nextval,1,'P03');

insert into p_public
values(SEQ_P_PUBLIC_NO.nextval,1,'P04');

insert into p_public
values(SEQ_P_PUBLIC_NO.nextval,1,'P05');

insert into p_public
values(SEQ_P_PUBLIC_NO.nextval,1,'P06');

insert into p_public
values(SEQ_P_PUBLIC_NO.nextval,1,'P07');

insert into p_public
values(SEQ_P_PUBLIC_NO.nextval,1,'P08');

insert into p_public
values(SEQ_P_PUBLIC_NO.nextval,1,'P09');


insert into p_public
values(SEQ_P_PUBLIC_NO.nextval,2,'P06');

insert into p_public
values(SEQ_P_PUBLIC_NO.nextval,2,'P07');

insert into p_public
values(SEQ_P_PUBLIC_NO.nextval,2,'P08');

insert into p_public
values(SEQ_P_PUBLIC_NO.nextval,2,'P09');


insert into p_public
values(SEQ_P_PUBLIC_NO.nextval,3,'P01');
insert into p_public
values(SEQ_P_PUBLIC_NO.nextval,3,'P02');
insert into p_public
values(SEQ_P_PUBLIC_NO.nextval,3,'P04');
insert into p_public
values(SEQ_P_PUBLIC_NO.nextval,3,'P06');
insert into p_public
values(SEQ_P_PUBLIC_NO.nextval,3,'P07');
insert into p_public
values(SEQ_P_PUBLIC_NO.nextval,3,'P08');



insert into p_public
values(SEQ_P_PUBLIC_NO.nextval,4,'P01');

insert into p_public
values(SEQ_P_PUBLIC_NO.nextval,4,'P02');

insert into p_public
values(SEQ_P_PUBLIC_NO.nextval,4,'P03');

insert into p_public
values(SEQ_P_PUBLIC_NO.nextval,4,'P04');

insert into p_public
values(SEQ_P_PUBLIC_NO.nextval,4,'P05');

insert into p_public
values(SEQ_P_PUBLIC_NO.nextval,4,'P06');


insert into p_public
values(SEQ_P_PUBLIC_NO.nextval,5,'P01');

----------------------------------------------------------------------
--성수기
insert into peck
values(SEQ_PECK_NO.nextval,1, to_date('2022-08-01', 'YYYY-MM-DD'),to_date('2022-08-31', 'YYYY-MM-DD'),1);
insert into peck
values(SEQ_PECK_NO.nextval,1, to_date('2022-09-01', 'YYYY-MM-DD'),to_date('2022-09-15', 'YYYY-MM-DD'),2);

insert into peck
values(SEQ_PECK_NO.nextval,2, to_date('2022-09-01', 'YYYY-MM-DD'),to_date('2022-09-21', 'YYYY-MM-DD'),1);
insert into peck
values(SEQ_PECK_NO.nextval,2, to_date('2022-07-15', 'YYYY-MM-DD'),to_date('2022-08-11', 'YYYY-MM-DD'),2);

insert into peck
values(SEQ_PECK_NO.nextval,3, to_date('2022-08-01', 'YYYY-MM-DD'),to_date('2022-08-31', 'YYYY-MM-DD'),1);
insert into peck
values(SEQ_PECK_NO.nextval,3, to_date('2022-09-01', 'YYYY-MM-DD'),to_date('2022-09-17', 'YYYY-MM-DD'),2);

insert into peck
values(SEQ_PECK_NO.nextval,4, to_date('2022-08-11', 'YYYY-MM-DD'),to_date('2022-08-21', 'YYYY-MM-DD'),1);
insert into peck
values(SEQ_PECK_NO.nextval,4, to_date('2022-08-22', 'YYYY-MM-DD'),to_date('2022-08-31', 'YYYY-MM-DD'),2);

insert into peck
values(SEQ_PECK_NO.nextval,5, to_date('2022-08-05', 'YYYY-MM-DD'),to_date('2022-08-15', 'YYYY-MM-DD'),1);
insert into peck
values(SEQ_PECK_NO.nextval,5, to_date('2022-09-01', 'YYYY-MM-DD'),to_date('2022-09-30', 'YYYY-MM-DD'),2);
...
--객실 요금
insert into prices
values(seq_prices_no.nextval,1,3,1,100000);

insert into prices
values(seq_prices_no.nextval,1,3,2,104000);

insert into prices
values(seq_prices_no.nextval,1,2,1,120000);

insert into prices
values(seq_prices_no.nextval,1,2,2,124000);

insert into prices
values(seq_prices_no.nextval,1,1,1,133000);

insert into prices
values(seq_prices_no.nextval,1,1,2,145000);


insert into prices
values(seq_prices_no.nextval,2,3,1,100000);

insert into prices
values(seq_prices_no.nextval,2,3,2,102000);

insert into prices
values(seq_prices_no.nextval,2,2,1,102300);

insert into prices
values(seq_prices_no.nextval,2,2,2,123000);

insert into prices
values(seq_prices_no.nextval,2,1,1,200000);

insert into prices
values(seq_prices_no.nextval,2,1,2,250000);

insert into prices
values(seq_prices_no.nextval,3,3,1,206000);
...
insert into prices
values(seq_prices_no.nextval,7,3,1,100000);

insert into prices
values(seq_prices_no.nextval,7,3,2,100001);

insert into prices
values(seq_prices_no.nextval,7,2,1,100002);

insert into prices
values(seq_prices_no.nextval,7,2,2,100003);

insert into prices
values(seq_prices_no.nextval,7,1,1,100004);

insert into prices
values(seq_prices_no.nextval,7,1,2,100005);

insert into prices
values(seq_prices_no.nextval,8,3,1,100006);

insert into prices
values(seq_prices_no.nextval,8,3,2,100007);

insert into prices
values(seq_prices_no.nextval,8,2,1,100008);

insert into prices
values(seq_prices_no.nextval,8,2,2,100009);

insert into prices
values(seq_prices_no.nextval,8,1,1,100010);

insert into prices
values(seq_prices_no.nextval,8,1,2,100011);


insert into prices
values(seq_prices_no.nextval,9,3,1,100012);

insert into prices
values(seq_prices_no.nextval,9,3,2,100013);

insert into prices
values(seq_prices_no.nextval,9,2,1,100014);

insert into prices
values(seq_prices_no.nextval,9,2,2,100015);

insert into prices
values(seq_prices_no.nextval,9,1,1,100016);

insert into prices
values(seq_prices_no.nextval,9,1,2,100017);



insert into prices
values(seq_prices_no.nextval,10,3,1,100018);

insert into prices
values(seq_prices_no.nextval,10,3,2,100019);

insert into prices
values(seq_prices_no.nextval,10,2,1,100020);

insert into prices
values(seq_prices_no.nextval,10,2,2,100021);

insert into prices
values(seq_prices_no.nextval,10,1,1,100022);

insert into prices
values(seq_prices_no.nextval,10,1,2,100023);
...
values(SEQ_RESERVATIONS_NO.nextval,1,1,'김민규','01025486545',to_date('2022-08-05','YYYY-MM-DD'),to_date('2022-08-06','YYYY-MM-DD'),2,2,0,190000,SYSDATE,'CARD','결제완료',3,0,0); --이용완료 1
insert into reservations
values(SEQ_RESERVATIONS_NO.nextval,1,1,'김밍키','01088574568',to_date('2022-08-26','YYYY-MM-DD'),to_date('2022-08-27','YYYY-MM-DD'),2,2,0,210000,SYSDATE,'CARD','결제완료',1,0,0); --예약완료 2
insert into reservations
values(SEQ_RESERVATIONS_NO.nextval,2,2,'김깨','01023545854', to_date('2022-08-26','YYYY-MM-DD'),to_date('2022-08-27','YYYY-MM-DD'),2,2,0,210000,SYSDATE,'CARD','결제완료',6,150000,0); -- 양도대기 3
--펜션 2
insert into reservations
values(SEQ_RESERVATIONS_NO.nextval,3,1,'김가루','01033548978',to_date('2022-08-24','YYYY-MM-DD'),to_date('2022-08-25','YYYY-MM-DD'),2,2,0,200000,SYSDATE,'CARD','결제완료',1,100000,0); --양도대기 4
insert into reservations
values(SEQ_RESERVATIONS_NO.nextval,3,2,'고기만두','01099856656',to_date('2022-08-26','YYYY-MM-DD'),to_date('2022-08-28','YYYY-MM-DD'),2,2,0,250000,SYSDATE,'CARD','결제완료',3,0,0); --예약완료 5
insert into reservations
values(SEQ_RESERVATIONS_NO.nextval,4,2,'김치만두','010332578598',to_date('2022-09-05','YYYY-MM-DD'),to_date('2022-09-06','YYYY-MM-DD'),2,2,0,300000,SYSDATE,'CARD','결제완료',1,0,0); --예약완료 6
insert into reservations
values(SEQ_RESERVATIONS_NO.nextval,4,1,'김민규','01023545854',to_date('2022-09-15','YYYY-MM-DD'),to_date('2022-09-16','YYYY-MM-DD'),2,2,0,800000,SYSDATE,'CARD','결제완료',1,0,0); --예약완료 7

--펜션3
insert into reservations
values(SEQ_RESERVATIONS_NO.nextval,5,1,'김민규','01055428786',to_date('2022-08-05','YYYY-MM-DD'),to_date('2022-08-06','YYYY-MM-DD'),2,2,0,350000,SYSDATE,'CARD','결제완료',3,0,0); --이용완료 8
insert into reservations
values(SEQ_RESERVATIONS_NO.nextval,5,1,'김민규','01022578687',to_date('2022-08-10','YYYY-MM-DD'),to_date('2022-08-12','YYYY-MM-DD'),2,2,0,400000,SYSDATE,'CARD','결제완료',3,0,0); --이용완료 9
insert into reservations
values(SEQ_RESERVATIONS_NO.nextval,6,1,'김민규','0103753578',to_date('2022-08-25','YYYY-MM-DD'),to_date('2022-08-27','YYYY-MM-DD'),2,2,0,450000,SYSDATE,'CARD','결제완료',6,250000,0); --양도대기 10
insert into reservations
values(SEQ_RESERVATIONS_NO.nextval,6,1,'김민규','0102537867',to_date('2022-09-13','YYYY-MM-DD'),to_date('2022-09-15','YYYY-MM-DD'),2,2,0,458000,SYSDATE,'CARD','결제완료',1,0,0); --예약완료 11
insert into reservations
values(SEQ_RESERVATIONS_NO.nextval,6,1,'김민규','01052738687',to_date('2022-09-14','YYYY-MM-DD'),to_date('2022-09-15','YYYY-MM-DD'),2,2,0,80000,SYSDATE,'CARD','결제완료',1,0,0); --예약완료 12
--펜션4
insert into reservations
values(SEQ_RESERVATIONS_NO.nextval,7,1,'김민규','01023012023',to_date('2022-08-02','YYYY-MM-DD'),to_date('2022-08-06','YYYY-MM-DD'),2,2,0,900000,SYSDATE,'CARD','결제완료',3,0,0); --이용완료 13
insert into reservations
values(SEQ_RESERVATIONS_NO.nextval,7,1,'김민규','01012312314',to_date('2022-08-23','YYYY-MM-DD'),to_date('2022-08-24','YYYY-MM-DD'),2,2,0,1000000,SYSDATE,'CARD','결제완료',2,0,0); --이용중 14
insert into reservations
values(SEQ_RESERVATIONS_NO.nextval,8,1,'김민규','0101231234',to_date('2022-08-25','YYYY-MM-DD'),to_date('2022-08-26','YYYY-MM-DD'),2,2,0,50000,SYSDATE,'CARD','결제완료',1,0,0); --예약완료 15
insert into reservations
values(SEQ_RESERVATIONS_NO.nextval,8,1,'김민규','01099382737',to_date('2022-08-30','YYYY-MM-DD'),to_date('2022-08-31','YYYY-MM-DD'),2,2,0,70000,SYSDATE,'CARD','결제완료',1,0,0); --예약완료 16
--펜션5
insert into reservations
values(SEQ_RESERVATIONS_NO.nextval,9,1,'김민규','01029384757',to_date('2022-08-29','YYYY-MM-DD'),to_date('2022-08-30','YYYY-MM-DD'),2,2,0,100016,SYSDATE,'CARD','결제완료',6,80000,0); --양도대기 17
insert into reservations
values(SEQ_RESERVATIONS_NO.nextval,10,1,'김민규','01055123548',to_date('2022-08-29','YYYY-MM-DD'),to_date('2022-08-31','YYYY-MM-DD'),2,2,0,10000,SYSDATE,'CARD','결제완료',1,0,0); --예약완료 18
