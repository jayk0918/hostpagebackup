...
--이용중
insert into reservations
values(SEQ_RESERVATIONS_NO.nextval,1,1,'김씨','01085231568','22.08.04 목 15:00','22.08.05 금 11:00',2,2,0,'170000',SYSDATE,'CARD','결제완료','이용중','','');

--이용완료
insert into reservations
values(SEQ_RESERVATIONS_NO.nextval,1,1,'김씨','01085231568','22.08.04 목 15:00','22.08.05 금 11:00',2,2,0,'170000',SYSDATE,'CARD','결제완료','이용완료','','');

--일반취소
insert into reservations
values(SEQ_RESERVATIONS_NO.nextval,1,1,'김씨','01085231568','22.08.04 목 15:00','22.08.05 금 11:00',2,2,0,'170000',SYSDATE,'CARD','결제완료','일반취소','','');
