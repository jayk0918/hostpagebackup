...
<div id = "container">
	...
	<div id = "process">
		<ul>
			<li class = "imgs">
				<a href="">
					<span><img src="../assets/img/mypage.png" class = "active"></span>
					<span>마이페이지 입력</span>
				</a>
			</li>
			<li class = "prog">
			...
			<li class = "imgs">
				<a href="">
					<span><img src="../assets/img/introduce.png"></span>
					<span>소개작성</span>
				</a>
			</li>
			<li class = "prog">
			...
			<li class = "imgs">
				<a href="">
					<span><img src="../assets/img/rules.png"></span>
					<span>이용규칙 관리</span>
				</a>
			</li>
			<li class = "prog">
			...
			<li class = "imgs">
				<a href="">
					<span><img src="../assets/img/room.png"></span>
					<span>객실 관리</span>
				</a>
			</li>
		</ul>
