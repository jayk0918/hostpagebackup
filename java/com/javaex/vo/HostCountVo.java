...
public class HostCountVo {
	...
	public HostCountVo(String today, String weekFirst, String weekLast, String monthFirst, String monthLast,
			int reviewToday, int reviewWeek, int reviewMonth, int saleToday, int saleWeek, int saleMonth,
			int pensionNo) {
		this.today = today;
	...
	public String toString() {
		return "HostCountVo [today=" + today + ", weekFirst=" + weekFirst + ", weekLast=" + weekLast + ", monthFirst="
				+ monthFirst + ", monthLast=" + monthLast + ", reviewToday=" + reviewToday + ", reviewWeek="
				+ reviewWeek + ", reviewMonth=" + reviewMonth + ", saleToday=" + saleToday + ", saleWeek=" + saleWeek
